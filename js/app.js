...
import { STATIC_PAGES as STATIC_PAGE_SEGMENTS } from './data/staticPages.js';
...
// Static pages (hand-built and generated) that bypass the SPA router; list is generated by build-seo.
const STATIC_PAGES = new Set(STATIC_PAGE_SEGMENTS);
