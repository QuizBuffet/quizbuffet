export const cert = {
  ...
  domains: [
    { slug: 'it-concepts-and-terminology', name: 'IT Concepts and Terminology', weight: 17, count: 0 },
    { slug: 'infrastructure',              name: 'Infrastructure',              weight: 22, count: 0 },
    { slug: 'applications-and-software',   name: 'Applications and Software',   weight: 18, count: 0 },
    { slug: 'software-development',        name: 'Software Development',        weight: 12, count: 0 },
    { slug: 'database-fundamentals',       name: 'Database Fundamentals',       weight: 11, count: 0 },
    { slug: 'security',                    name: 'Security',                    weight: 20, count: 0 },
  ],
};
