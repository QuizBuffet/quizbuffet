export const cert = {
  ...
  domains: [
    { slug: 'security-operations',          name: 'Security Operations',          weight: 33, count: 0 },
    { slug: 'vulnerability-management',     name: 'Vulnerability Management',     weight: 30, count: 0 },
    { slug: 'incident-response-management', name: 'Incident Response Management', weight: 20, count: 0 },
    { slug: 'reporting-and-communication',  name: 'Reporting and Communication',  weight: 17, count: 0 },
  ],
};
