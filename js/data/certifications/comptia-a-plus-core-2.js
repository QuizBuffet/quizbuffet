export const cert = {
  ...
  domains: [
    { slug: 'operating-systems',        name: 'Operating Systems',        weight: 28, count: 11 },
    { slug: 'security',                 name: 'Security',                 weight: 28, count: 11 },
    { slug: 'software-troubleshooting', name: 'Software Troubleshooting', weight: 23, count: 4  },
    { slug: 'operational-procedures',   name: 'Operational Procedures',   weight: 21, count: 10 },
  ],
};
