...
export const cert = {
  ...
  domains: [
    { slug: 'forklift-fundamentals',              name: 'Forklift Fundamentals and General Rules',      number: '1.0', weight: 10 },
    { slug: 'stability-and-load-center',          name: 'Stability and Load Center',                    number: '2.0', weight: 20 },
    { slug: 'pre-operation-and-seat-belt-safety', name: 'Pre-Operation and Seat Belt Safety',           number: '3.0', weight: 10 },
    { slug: 'load-handling-and-traveling',        name: 'Load Handling, Traveling, and Stacking',       number: '4.0', weight: 25 },
    { slug: 'operating-around-pedestrians',       name: 'Operating Around Pedestrians',                 number: '5.0', weight: 10 },
    { slug: 'lifting-people-on-work-platforms',   name: 'Lifting People on Work Platforms',             number: '6.0', weight: 5  },
    { slug: 'training-evaluation-and-certification', name: 'Training, Evaluation, and Certification',   number: '7.0', weight: 20 },
  ],
};
