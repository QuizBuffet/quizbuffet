export const cert = {
  ...
  domains: [
    { slug: 'mobile-devices',                        name: 'Mobile Devices',                        weight: 15, count: 4 },
    { slug: 'networking',                            name: 'Networking',                            weight: 20, count: 8 },
    { slug: 'hardware',                              name: 'Hardware',                              weight: 25, count: 7 },
    { slug: 'virtualization-and-cloud-computing',    name: 'Virtualization and Cloud Computing',    weight: 11, count: 2 },
    { slug: 'hardware-and-network-troubleshooting',  name: 'Hardware and Network Troubleshooting',  weight: 29, count: 7 },
  ],
};
