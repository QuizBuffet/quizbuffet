export const cert = {
  ...
  domains: [
    { slug: 'data-concepts-and-environments',  name: 'Data Concepts and Environments',  weight: 20, count: 0 },
    { slug: 'data-acquisition-and-preparation', name: 'Data Acquisition and Preparation', weight: 22, count: 0 },
    { slug: 'data-analysis',                   name: 'Data Analysis',                   weight: 24, count: 0 },
    { slug: 'visualization-and-reporting',     name: 'Visualization and Reporting',     weight: 20, count: 0 },
    { slug: 'data-governance',                 name: 'Data Governance',                 weight: 14, count: 0 },
  ],
};
