import { acronyms } from '../acronyms/cpa-aud.js';
import { services } from '../services/cpa-aud.js';
...
export const cert = {
  ...
  domains: [
    ...
    { slug: 'performing-procedures-and-evidence',    name: 'Performing Further Procedures and Obtaining Evidence',         number: '3.0', weight: 35 },
    { slug: 'forming-conclusions-and-reporting',     name: 'Forming Conclusions and Reporting',                            number: '4.0', weight: 15 },
  ],
};
