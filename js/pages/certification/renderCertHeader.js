...
export function renderCertHeader(cert) {
  ...
  el.innerHTML = `
    <div style="margin: 18px 0 12px">
      ...
      <h1 style="font-size:clamp(20px,5vw,26px);font-weight:700;margin:4px 0 6px;line-height:1.3">${nameHtml} <span style="color:var(--text-muted);font-weight:400;font-size:clamp(14px,3.5vw,16px)">${cert.code}</span></h1>
